...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('icons/uicons/css/uicons-regular-rounded.css') }}">
                ...
                <form name="formTidakTetapHarian" method="POST">
                    <div class="page slide-page2">
                        <div class="field">
                            <div class="label-long">Penghasilan Bruto</div>
                            <div class="col-75">
                                <input type="text" class="form-control" name="brutoTidakTetapHarian" id="brutoTidakTetapHarian" style="text-align:right" placeholder="0" onFocus="startCalc();" onBlur="stopCalc();">
                            </div>
                        </div>
                        <button type="button" id="hitungTidakTetapHarian" class="hitung" onclick="hitungTidakTetapHarian()">Hitung</button>
                        <div class="title1">Penghitungan PPh Pasal 21</div>
                        <div class="field">
                            <label class="label-long">DPP</label>
                            <div class="col-75">
                                <input type="text" disabled="true" readonly="readonly" class="form-control" name="dppTidakTetapHarian" id="dppTidakTetapHarian" placeholder="0" style="text-align:right">
                            </div>
                        </div>
                        <div class="field">
                            <label class="label-long">Tarif</label>
                            <div class="col-75">
                                <input type="text" disabled="true" readonly="readonly" class="form-control" name="tarifTidakTetapHarian" id="tarifTidakTetapHarian" placeholder="0" style="text-align:right">
                            </div>
                        </div>
                        <div class="field">
                ...
                <form id="formTidakTetapBulanan" method="POST">
                    <div class="page slide-page2">
                        ...
                        <div class="field">
                            <div class="label-long">Penghasilan Bruto</div>
                            <div class="col-75">
                                <input type="text" class="form-control" name="brutoTidakTetapBulanan" id="brutoTidakTetapBulanan" style="text-align:right" placeholder="0" onFocus="startCalc();" onBlur="stopCalc();">
                            </div>
                        </div>
                        ...
                        <div class="field">
                            <label class="label-long">DPP</label>
                            <div class="col-75">
                                <input type="text" disabled="true" readonly="readonly" class="form-control" name="dppTidakTetapBulanan" id="dppTidakTetapBulanan" placeholder="0" style="text-align:right" onFocus="startCalc();" onBlur="stopCalc();">
                            </div>
                        </div>
                        <div class="field">
                            <label class="label-long">Tarif</label>
                            <div class="col-75">
                                <input type="text" disabled="true" readonly="readonly" class="form-control" name="tarifTidakTetapBulanan" id="tarifTidakTetapBulanan" placeholder="0" style="text-align:right" onFocus="startCalc();" onBlur="stopCalc();">
                            </div>
                        </div>
                        <div class="field">
                            <label class="label-long">PPh 21</label>
