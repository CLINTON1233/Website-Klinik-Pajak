                ...
                <div class="col-lg-3">
                    <div class="card" style="width: 100%;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route ('kuliner') }}" class="btn btn-primary mt-3">Lihat Selengkapnya</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="card" style="width: 100%;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route ('fashion') }}" class="btn btn-primary mt-3">Lihat Selengkapnya</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="card" style="width: 100%;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route ('otomotif') }}" class="btn btn-primary mt-3">Lihat Selengkapnya</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-3">
                    <div class="card" style="width: 100%;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route ('agribisnis') }}" class="btn btn-primary mt-3">Lihat Selengkapnya</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="card" style="width: 100%;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route ('kosmetik') }}" class="btn btn-primary mt-3">Lihat Selengkapnya</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="card" style="width: 100%;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route ('event') }}" class="btn btn-primary mt-3">Lihat Selengkapnya</a>
                        </div>
                    </div>
                </div>
            </div>
