                    ...
                    <div class="rs-carousel owl-carousel wow" data-loop="true" data-items="3" data-margin="30" data-autoplay="true" data-autoplay-timeout="700" data-smart-speed="5000" data-dots="false" data-nav="false" data-nav-speed="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="2" data-ipad-device-nav="false" data-ipad-device-dots="false" data-ipad-device2="1" data-ipad-device-nav2="false" data-ipad-device-dots2="false" data-md-device="3" data-md-device-nav="false" data-md-device-dots="false">
                        <div class="single-blog style2 white-bg ">
                            ...
                            <div class="blog-details">
                                <div class="blog-desc">
                                    <h3 class="blog-title"><a href="{{ route ('konsultan') }}">Konsultasi</a></h3>
                                    <ul class="blog-meta">
                                    ...
                                    <div class="about-btn">
                                        <a style="width: -10px; left: 5px;" class="readon radius" href="{{ route ('konsultan') }}">Lebih Lanjut</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="single-blog style2 white-bg ">
                            ...
                            <div class="blog-details">
                                <div class="blog-desc">
                                    <h3 class="blog-title"><a href="{{ route ('pelatihan') }}">Pelatihan atau Sertifikasi</a></h3>
                                    <ul class="blog-meta">
                                    ...
                                    <div class="about-btn">
                                        <a style="width: -10px; left: 5px;" class="readon radius" href="{{ route ('pelatihan') }}">Lebih
                                            Lanjut</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="single-blog style2 white-bg">
                            ...
                            <div class="blog-details">
                                <div class="blog-desc">
                                    <h3 class="blog-title"><a href="{{ route ('daftar_berita') }}">Berita</a></h3>
                                    <ul class="blog-meta">
                                        <li>Memberikan informasi terkait peristiwa-peristiwa yang berkaitan dengan perpajakan. </li><br><br><br>
                                    </ul>
                                    <div class="about-btn">
                                        <a style="width: -10px; left: 5px;" class="readon radius" href="{{ route ('daftar_berita') }}">Lebih
                                            Lanjut</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="single-blog style2 white-bg">
                            ...
                            <div class="blog-details">
                                <div class="blog-desc">
                                    <h3 class="blog-title"><a href="{{ route ('kategori_usaha') }}">Kategori Perbidang Usaha</a></h3>
                                    <ul class="blog-meta">
                                    ...
                                    <div class="about-btn">
                                        <a style="width: -10px; left: 5px;" class="readon radius" id="konsultasi" href="{{ route ('kategori_usaha') }}">Lebih Lanjut</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <div class="about-btn">
                    <a class="readon radius" href="{{ route ('beranda') }}">Mulai Sekarang</a>
                </div>
            </div>
        </div>
    </div>
   ...
   <div class="sec-title text-center mb-50" id="berita"><br><br><br><br><br><br><br><br><br>
    ...
    <div class="container2">
        ...
        ?>
            <div class="artikel-<?= $idx++; ?>">
                <div class="card2">
                    <img class="thumb" src="tables/cover_berita/<?= $r['cover'] ?>" alt="">
                    ...
                    <article>
                        ...
                        <p style="text-align: left;"><?= substr($r['isi'], 0, 180) ?> <a href="{{ route ('detail_berita') }}?id=<?= $r['id'] ?>">read more</a></p>
                        <ul class="blog-meta">
    ...
    <div class="col-lg-3 col-md-4">
        <div class="show-more text-right sm-text-left mt-35 sm-mt-25">
            <a style="width: -30px; left: 450px;" class="readon style2 radius" href="{{ route ('daftar_berita') }}">Lihat Berita Lainnya</a>
        </div>
    </div><br><br><br><br><br>
    <!-- Berita End-->
