                                     ...
                                     <form action="conf/autentikasi.php" method="post">
                                         ...
                                         <div class="mb-3">
                                             ...
                                             <input type="password" class="form-control py-2"
                                                 placeholder="Enter Password" id="exampleInputEmail1" name="password"
                                                 aria-describedby="emailHelp" required>
                                         </div>
                                         <div class="form-group mb-3">
                                             <button onclick="sukses()" type="submit"
                                                 class="btn btn-primary btn-block swalDefaultSuccess">Login</button>
                                         </div>
