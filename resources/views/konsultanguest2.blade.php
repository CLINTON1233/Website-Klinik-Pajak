...
require_once('../public/controller/session_expired.php');
                                ...
                                <nav style="margin-left: 90px;" class="rs-menu">
                                    <ul class="nav-menu">
                                        <li class="current-menu-item current_page_item menu-item-has-children">
                                            <a href="{{ route ('konsultan') }}">Beranda</a>
                                        </li>
    ...
    <section>
        <div class="container mt-5 pt-5">
            <div class="row border-bottom ">
                ...
                @include('layout.caption-kiri')

                </div>

                @include('layout.konsultan-listGuest')
